/* media-native.c - general routines related to playing sounds
 **
...

static void
media_native_analyse_data(Lisp_Media_Stream *ms, char *data)
{
...
void media_native_analyse_stream(Lisp_Media_Stream *ms)
{
	/* stuff for file handling */
	int fd = -1, len;
	/* data probe for the native analyser */
	char *data;
	/* stream stuff */
	media_substream *mss;
	...
	media_native_analyse_data(ms, data);
