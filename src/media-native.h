/* media-native.h - general routines related to playing sounds
 **
...
#ifndef INCLUDED_media_native_h_
#define INCLUDED_media_native_h_
...
extern void media_native_analyse_stream(Lisp_Media_Stream*);

#endif	/* INCLUDED_media_native_h_ */
