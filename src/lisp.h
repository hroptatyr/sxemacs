...
#define GCPRO4(var1, var2, var3, var4)					\
	((void)(							\
		...
		gcpro3.var = &var3, gcpro3.nvars = 1,			\
		gcpro4.next = &gcpro3,					\
		gcpro4.var = &var4, gcpro4.nvars = 1,			\
		_set_gcprolist(&gcpro4),				\
		unlock_allocator()))
...
#define GCPRO5(var1, var2, var3, var4, var5)				\
	((void)(							\
		...
		gcpro4.var = &var4, gcpro4.nvars = 1,			\
		gcpro5.next = &gcpro4,					\
		gcpro5.var = &var5, gcpro5.nvars = 1,			\
		_set_gcprolist(&gcpro5),				\
		unlock_allocator()))
...
#define GCPRO6(var1, var2, var3, var4, var5, var6 )			\
	((void)(							\
		...
		gcpro5.var = &var5, gcpro5.nvars = 1,			\
		gcpro6.next = &gcpro5,					\
		gcpro6.var = &var6, gcpro6.nvars = 1,			\
		_set_gcprolist(&gcpro6),				\
		unlock_allocator()))

#define GCPRO7(var1, var2, var3, var4, var5, var6, var7)		\
	((void)(							\
		lock_allocator(),					\
		gcpro1.next = _get_gcprolist(),				\
		gcpro1.var = &var1, gcpro1.nvars = 1,			\
		...
		gcpro6.var = &var6, gcpro6.nvars = 1,			\
		gcpro7.next = &gcpro6,					\
		gcpro7.var = &var7, gcpro7.nvars = 1,			\
		_set_gcprolist(&gcpro7),				\
		unlock_allocator()))

#define GCPRO8(var1, var2, var3, var4, var5, var6, var7, var8)		\
	((void)(							\
		lock_allocator(),					\
		gcpro1.next = _get_gcprolist(),				\
		gcpro1.var = &var1, gcpro1.nvars = 1,			\
		...
		gcpro7.var = &var7, gcpro7.nvars = 1,			\
		gcpro8.next = &gcpro7,					\
		gcpro8.var = &var8, gcpro8.nvars = 1,			\
		_set_gcprolist(&gcpro8),				\
		unlock_allocator()))

#define GCPROn(_varp, _nvars)			\
	((void)(				\
		lock_allocator(),		\
		gcpro1.next = _get_gcprolist(),	\
		gcpro1.var = _varp,		\
...
#define GCPRO1n(_v1, _varp, _nvars)					\
	((void)(							\
		lock_allocator(),					\
		gcpro1.next = _get_gcprolist(),				\
		gcpro1.var = &_v1, gcpro1.nvars = 1,			\
		gcpro2.next = &gcpro1,					\
		gcpro2.var = _varp, gcpro2.nvars = _nvars,		\
		_set_gcprolist(&gcpro2),				\
		unlock_allocator()))

#define GCPRO2n(_v1, _v2, _varp, _nvars)				\
	((void)(							\
		lock_allocator(),					\
		gcpro1.next = _get_gcprolist(),				\
		gcpro1.var = &_v1, gcpro1.nvars = 1,			\
		gcpro2.next = &gcpro1,					\
		gcpro2.var = &_v2, gcpro2.nvars = 1,			\
		gcpro3.next = &gcpro2,					\
		gcpro3.var = _varp, gcpro3.nvars = _nvars,		\
		_set_gcprolist(&gcpro3),				\
		unlock_allocator()))

#define GCPRO3n(_v1, _v2, _v3, _varp, _nvars)				\
	((void)(							\
		lock_allocator(),					\
		gcpro1.next = _get_gcprolist(),				\
		gcpro1.var = &_v1, gcpro1.nvars = 1,			\
		...
		gcpro2.var = &_v2, gcpro2.nvars = 1,			\
		gcpro3.next = &gcpro2,					\
		gcpro3.var = &_v3, gcpro3.nvars = 1,			\
		gcpro4.next = &gcpro3,					\
		gcpro4.var = _varp, gcpro4.nvars = _nvars,		\
		_set_gcprolist(&gcpro4),				\
		unlock_allocator()))

#define GCPRO1nn(_v1, _varp1, _nv1, _varp2, _nv2)			\
	((void)(							\
		lock_allocator(),					\
		gcpro1.next = _get_gcprolist(),				\
		gcpro1.var = &_v1, gcpro1.nvars = 1,			\
		gcpro2.next = &gcpro1,					\
		gcpro2.var = _varp1, gcpro2.nvars = _nv1,		\
		gcpro3.next = &gcpro2,					\
		gcpro3.var = _varp2, gcpro3.nvars = _nv2,		\
		_set_gcprolist(&gcpro3),				\
		unlock_allocator()))
...
#define UNGCPRO						\
	((void)(					\
		lock_allocator(),			\
		_set_gcprolist(gcpro1.next),		\
		unlock_allocator()))

#define NGCPRO1(var1)							\
	((void) (							\
		lock_allocator(),					\
		ngcpro1.next = _get_gcprolist(),			\
		ngcpro1.var = &var1, ngcpro1.nvars = 1,			\
		_set_gcprolist(&ngcpro1),				\
		unlock_allocator()))

#define NGCPRO2(var1, var2)						\
	((void) (							\
		lock_allocator(),					\
		ngcpro1.next = _get_gcprolist(),			\
		ngcpro1.var = &var1, ngcpro1.nvars = 1,			\
		ngcpro2.next = &ngcpro1,				\
		ngcpro2.var = &var2, ngcpro2.nvars = 1,			\
		_set_gcprolist(&ngcpro2),				\
		unlock_allocator()))

#define NGCPRO3(var1, var2, var3)					\
	((void) (							\
		lock_allocator(),					\
		ngcpro1.next = _get_gcprolist(),			\
		ngcpro1.var = &var1, ngcpro1.nvars = 1,			\
		ngcpro2.next = &ngcpro1,				\
		ngcpro2.var = &var2, ngcpro2.nvars = 1,			\
		ngcpro3.next = &ngcpro2,				\
		ngcpro3.var = &var3, ngcpro3.nvars = 1,			\
		_set_gcprolist(&ngcpro3),				\
		unlock_allocator()))

#define NGCPRO4(var1, var2, var3, var4)					\
	((void) (							\
		lock_allocator(),					\
		ngcpro1.next = _get_gcprolist(),			\
		ngcpro1.var = &var1, ngcpro1.nvars = 1,			\
		...
		ngcpro3.next = &ngcpro2,				\
		ngcpro3.var = &var3, ngcpro3.nvars = 1,			\
		ngcpro4.next = &ngcpro3,				\
		ngcpro4.var = &var4, ngcpro4.nvars = 1,			\
		_set_gcprolist(&ngcpro4),				\
		unlock_allocator()))
...
#define NGCPRO5(var1, var2, var3, var4, var5)				\
	((void) (							\
		...
		ngcpro4.next = &ngcpro3,				\
		ngcpro4.var = &var4, ngcpro4.nvars = 1,			\
		ngcpro5.next = &ngcpro4,				\
		ngcpro5.var = &var5, ngcpro5.nvars = 1,			\
		_set_gcprolist(&ngcpro5),				\
		unlock_allocator()))

#define NGCPRO6(var1, var2, var3, var4, var5, var6 )			\
	((void) (							\
		lock_allocator(),					\
		ngcpro1.next = _get_gcprolist(),			\
		ngcpro1.var = &var1, ngcpro1.nvars = 1,			\
		...
		ngcpro5.next = &ngcpro4,				\
		ngcpro5.var = &var5, ngcpro5.nvars = 1,			\
		ngcpro6.next = &ngcpro5,				\
		ngcpro6.var = &var6, ngcpro6.nvars = 1,			\
		_set_gcprolist(&ngcpro6),				\
		unlock_allocator()))

#define NGCPRO7(var1, var2, var3, var4, var5, var6, var7)		\
	((void) (							\
		lock_allocator(),					\
		ngcpro1.next = _get_gcprolist(),			\
		ngcpro1.var = &var1, ngcpro1.nvars = 1,			\
		...
		ngcpro6.next = &ngcpro5,				\
		ngcpro6.var = &var6, ngcpro6.nvars = 1,			\
		ngcpro7.next = &ngcpro6,				\
		ngcpro7.var = &var7, ngcpro7.nvars = 1,			\
		_set_gcprolist(&ngcpro7),				\
		unlock_allocator()))

#define NGCPRO8(var1, var2, var3, var4, var5, var6, var7, var8)		\
	((void) (							\
		lock_allocator(),					\
		ngcpro1.next = _get_gcprolist(),			\
		ngcpro1.var = &var1, ngcpro1.nvars = 1,			\
		...
		ngcpro7.next = &ngcpro6,				\
		ngcpro7.var = &var7, ngcpro7.nvars = 1,			\
		ngcpro8.next = &ngcpro7,				\
		ngcpro8.var = &var8, ngcpro8.nvars = 1,			\
		_set_gcprolist(&ngcpro8),				\
		unlock_allocator()))

#define NGCPROn(_varp, _nvars)				\
	((void)(					\
		lock_allocator(),			\
		ngcpro1.next = _get_gcprolist(),	\
		ngcpro1.var = _varp,			\
		ngcpro1.nvars = _nvars,			\
		_set_gcprolist(&ngcpro1),		\
		unlock_allocator()))

#define NGCPRO1n(_v1, _varp, _nvars)					\
	((void)(							\
		lock_allocator(),					\
		ngcpro1.next = _get_gcprolist(),			\
		ngcpro1.var = &_v1, ngcpro1.nvars = 1,			\
		ngcpro2.next = &ngcpro1,				\
		ngcpro2.var = _varp, ngcpro2.nvars = _nvars,		\
		_set_gcprolist(&ngcpro2),				\
		unlock_allocator()))
...
#define NUNGCPRO					\
	((void) (					\
		lock_allocator(),			\
		_set_gcprolist(ngcpro1.next),		\
		unlock_allocator()))

#define NNGCPRO1(var1)							\
	((void) (							\
		lock_allocator(),					\
		nngcpro1.next = _get_gcprolist(),			\
		nngcpro1.var = &var1, nngcpro1.nvars = 1,		\
		_set_gcprolist(&nngcpro1),				\
		unlock_allocator()))

#define NNGCPRO2(var1, var2)						\
	((void) (							\
		lock_allocator(),					\
		nngcpro1.next = _get_gcprolist(),			\
		nngcpro1.var = &var1, nngcpro1.nvars = 1,		\
		nngcpro2.next = &nngcpro1,				\
		nngcpro2.var = &var2, nngcpro2.nvars = 1,		\
		_set_gcprolist(&nngcpro2),				\
		unlock_allocator()))

#define NNGCPRO3(var1, var2, var3)					\
	((void) (							\
		lock_allocator(),					\
		nngcpro1.next = _get_gcprolist(),			\
		nngcpro1.var = &var1, nngcpro1.nvars = 1,		\
		nngcpro2.next = &nngcpro1,				\
		nngcpro2.var = &var2, nngcpro2.nvars = 1,		\
		nngcpro3.next = &nngcpro2,				\
		nngcpro3.var = &var3, nngcpro3.nvars = 1,		\
		_set_gcprolist(&nngcpro3),				\
		unlock_allocator()))

#define NNGCPRO4(var1, var2, var3, var4)				\
	((void) (							\
		lock_allocator(),					\
		nngcpro1.next = _get_gcprolist(),			\
		nngcpro1.var = &var1, nngcpro1.nvars = 1,		\
		...
		nngcpro3.next = &nngcpro2,				\
		nngcpro3.var = &var3, nngcpro3.nvars = 1,		\
		nngcpro4.next = &nngcpro3,				\
		nngcpro4.var = &var4, nngcpro4.nvars = 1,		\
		_set_gcprolist(&nngcpro4),				\
		unlock_allocator()))
...
#define NNGCPRO5(var1, var2, var3, var4, var5)				\
	((void) (							\
		...
		nngcpro4.next = &nngcpro3,				\
		nngcpro4.var = &var4, nngcpro4.nvars = 1,		\
		nngcpro5.next = &nngcpro4,				\
		nngcpro5.var = &var5, nngcpro5.nvars = 1,		\
		_set_gcprolist(&nngcpro5),				\
		unlock_allocator()))

#define NNGCPRO6(var1, var2, var3, var4, var5, var6 )			\
	((void) (							\
		lock_allocator(),					\
		nngcpro1.next = _get_gcprolist(),			\
		nngcpro1.var = &var1, nngcpro1.nvars = 1,		\
		...
		nngcpro5.next = &nngcpro4,				\
		nngcpro5.var = &var5, nngcpro5.nvars = 1,		\
		nngcpro6.next = &nngcpro5,				\
		nngcpro6.var = &var6, nngcpro6.nvars = 1,		\
		_set_gcprolist(&nngcpro6),				\
		unlock_allocator()))

#define NNGCPRO7(var1, var2, var3, var4, var5, var6, var7)		\
	((void) (							\
		lock_allocator(),					\
		nngcpro1.next = _get_gcprolist(),			\
		nngcpro1.var = &var1, nngcpro1.nvars = 1,		\
		...
		nngcpro6.next = &nngcpro5,				\
		nngcpro6.var = &var6, nngcpro6.nvars = 1,		\
		nngcpro7.next = &nngcpro6,				\
		nngcpro7.var = &var7, nngcpro7.nvars = 1,		\
		_set_gcprolist(&nngcpro7),				\
		unlock_allocator()))

#define NNGCPRO8(var1, var2, var3, var4, var5, var6, var7, var8)	\
	((void) (							\
		lock_allocator(),					\
		nngcpro1.next = _get_gcprolist(),			\
		nngcpro1.var = &var1, nngcpro1.nvars = 1,		\
		...
		nngcpro7.next = &nngcpro6,				\
		nngcpro7.var = &var7, nngcpro7.nvars = 1,		\
		nngcpro8.next = &nngcpro7,				\
		nngcpro8.var = &var8, nngcpro8.nvars = 1,		\
		_set_gcprolist(&nngcpro8),				\
		unlock_allocator()))

#define NNGCPROn(_varp, _nvars)				\
	((void)(					\
		lock_allocator(),			\
		nngcpro1.next = _get_gcprolist(),	\
		nngcpro1.var = _varp,			\
		nngcpro1.nvars = _nvars,		\
		_set_gcprolist(&nngcpro1),		\
		unlock_allocator()))
...
#define NNUNGCPRO					\
	((void) (					\
		lock_allocator(),			\
		_set_gcprolist(nngcpro1.next),		\
		unlock_allocator()))

#endif	/* BDWGC */

#else /* defined(DEBUG_GCPRO) */
...
#define RETURN_IF_NOT_UNBOUND(expr)	\
	do {							\
...
#define DO_REALLOC(basevar, sizevar, needed_size, type)			\
	do {								\
		EMACS_INT cache_needed_size = (needed_size);		\
...
#define DO_REALLOC_ATOMIC(basevar, sizevar, needed_size, type)		\
	do {								\
		EMACS_INT cache_needed_size = (needed_size);		\
		if (LIKELY((sizevar) >= cache_needed_size)) {		\
			break;						\
...
#define free_me		__free_me __attribute__((unused))
#endif

static inline Lisp_Object
free_malloced_ptr(Lisp_Object unwind_obj)
{
	void *free_me = (void*)get_opaque_ptr(unwind_obj);
	xfree(free_me);
...
#define XMALLOC_OR_ALLOCA(ptr, len, type)				\
	do {								\
		size_t XOA_len = (len);					\
...
#define XMALLOC_ATOMIC_OR_ALLOCA(ptr, len, type)			\
	do {								\
		size_t XOA_len = (len);					\
		if (XOA_len > MAX_ALLOCA) {				\
			ptr = xnew_atomic_array(type, XOA_len);		\
			record_unwind_protect(free_malloced_ptr,	\
					      make_opaque_ptr((void*)ptr)); \
		} else {						\
			ptr = alloca_array(type, XOA_len);		\
...
#define XMALLOC_UNBIND(ptr, len, speccount)				\
	do {								\
		if ((len) > MAX_ALLOCA) {				\
...
#elif SIZEOF_VOID_P == SIZEOF_LONG_LONG_INT
...
{
	char probe;
	return sys_stk_sz - (stack_bottom - &probe);
}
...
Lisp_Object make_string_nocopy(Bufbyte*, Bytecount);
...
#if 0
/* superseded by ent-binary-rel stuff */
...
Bytecount emacs_doprnt_lisp_2(Lisp_Object, const Bufbyte *, Lisp_Object,
			      Bytecount, int, ...);
Lisp_Object emacs_doprnt_string_c(const Bufbyte *, Lisp_Object, Bytecount, ...);
...
Lisp_Object make_string_from_buffer_no_extents(struct buffer *, Bufpos,
					       Charcount);
...
Lisp_Object maybe_continuable_error_with_frob
    (Lisp_Object, Lisp_Object, Error_behavior, const char *, ...) PRINTF_ARGS(4,
									      5);
DECLARE_DOESNT_RETURN(signal_simple_error_2
		      (const char *, Lisp_Object, Lisp_Object));
void maybe_signal_simple_error_2(const char *, Lisp_Object, Lisp_Object,
				 Lisp_Object, Error_behavior);
Lisp_Object signal_simple_continuable_error_2(const char *, Lisp_Object,
					      Lisp_Object);
...
DECLARE_DOESNT_RETURN(syntax_error_2(const char *reason, Lisp_Object frob1,
				     Lisp_Object frob2));
DECLARE_DOESNT_RETURN(invalid_argument(const char *reason, Lisp_Object frob));
DECLARE_DOESNT_RETURN(invalid_argument_2(const char *reason,
					 Lisp_Object frob1, Lisp_Object frob2));
DECLARE_DOESNT_RETURN(invalid_operation(const char *reason, Lisp_Object frob));
DECLARE_DOESNT_RETURN(invalid_operation_2(const char *reason,
					  Lisp_Object frob1,
					  Lisp_Object frob2));
DECLARE_DOESNT_RETURN(invalid_change(const char *reason, Lisp_Object frob));
...
Lisp_Object eval_in_buffer_trapping_errors(char*, struct buffer *, Lisp_Object);
Lisp_Object run_hook_trapping_errors(char*, Lisp_Object);
Lisp_Object safe_run_hook_trapping_errors(char*, Lisp_Object, int);
Lisp_Object call0_trapping_errors(char*, Lisp_Object);
Lisp_Object call1_trapping_errors(char*, Lisp_Object, Lisp_Object);
...
Lisp_Object external_plist_get(Lisp_Object *, Lisp_Object, int, Error_behavior);
...
int unified_range_table_bytes_used(const void*);
...
struct re_registers;
Bufpos scan_buffer(struct buffer *, Emchar, Bufpos, Bufpos, EMACS_INT,
		   EMACS_INT *, int);
...
long unsigned int hash_string(const Bufbyte*, Bytecount);
...
extern Lisp_Object Qafter_change_major_mode_hook;
...
extern Lisp_Object Qlistp, Qload, Qlocalhost, Qlock_shift, Qmacro;
...
extern Lisp_Object Qpointer_image_instance_p, Qpositivep, Qpost_read_conversion;
...
extern Lisp_Object Qstring_greaterp, Qstring_lessp, Qsubwindow;
...
extern Lisp_Object Vafter_change_major_mode_hook;
...
extern Lisp_Object Vrecent_keys_ring, Vshell_file_name;
