...
#define __GC_DEBUG__(args...)		fprintf(stderr, "GC " args)
#ifndef GC_DEBUG_FLAG
#define GC_DEBUG(args...)
#else
#define GC_DEBUG(args...)		__GC_DEBUG__(args)
#endif
#define GC_DEBUG_PT(args...)		GC_DEBUG("[pthread]: " args)
#define GC_CRITICAL(args...)		__GC_DEBUG__("CRITICAL: " args)
...
lock_allocator(void)
{
	GC_DEBUG_PT("locking cons mutex.\n");
...
unlock_allocator(void)
{
	GC_DEBUG_PT("unlocking cons mutex.\n");
...
extern inline struct gcpro *_get_gcprolist(void);
extern inline void _set_gcprolist(struct gcpro *provar);

extern inline struct gcpro*
_get_gcprolist(void)
{
...
Lisp_Object call2_trapping_errors(const char *,
				  Lisp_Object, Lisp_Object, Lisp_Object);
Lisp_Object call3_trapping_errors(const char *,
				  Lisp_Object, Lisp_Object, Lisp_Object, 
                                  Lisp_Object);
