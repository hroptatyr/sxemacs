...
struct specifier_methods {
	...
	void (*after_change_method) (Lisp_Object specifier, Lisp_Object locale);
...
extern_inline struct type##_specifier *					\
...
struct specifier_caching {
	...
	void (*value_changed_in_window) (Lisp_Object specifier,
...
void add_spec_to_ghost_specifier(Lisp_Object specifier,
				 Lisp_Object instantiator, Lisp_Object locale,
				 Lisp_Object tag_set, Lisp_Object how_to_add);
