...
extern inline size_t xmin_size_t(size_t a, size_t b);
extern void x__dirname(char *restrict res, const char *file, size_t len);
extern size_t x__dirlen(const char *file, size_t len);
extern inline char *xdirname(const char *file);
