...
/* relations */
static Lisp_Object
ent_eq_QUATERN_T(Lisp_Object l, Lisp_Object r)
{
...
static Lisp_Object
ent_ne_QUATERN_T(Lisp_Object l, Lisp_Object r)
{
	return (bigz_eql(quatern_z(XQUATERN_DATA(l)),
			 quatern_z(XQUATERN_DATA(r))) &&
		bigz_eql(quatern_i(XQUATERN_DATA(l)),
...
/* lifts */
static Lisp_Object
ent_lift_all_QUATERN_T(Lisp_Object number, unsigned long precision)
{
	number_type nt = get_number_type(number);

	number = ent_optable_lift[nt][BIGZ_T](number, precision);
	bigz_set_long(ent_scratch_bigz, 0);
...
#ifdef HAVE_MPZ
static Lisp_Object
ent_lift_COMPLEX_QUATERN_T(Lisp_Object number, unsigned long precision)
{
	number_type nt;
	Lisp_Object z, i;
	...
	nt = get_number_type(z);
	z = ent_optable_lift[nt][BIGZ_T](z, precision);
	nt = get_number_type(i);
	i = ent_optable_lift[nt][BIGZ_T](i, precision);
...
void init_optables_QUATERN_T(void)
{
	...
	ent_optable_eq[QUATERN_T][QUATERN_T] = ent_eq_QUATERN_T;
	ent_optable_ne[QUATERN_T][QUATERN_T] = ent_ne_QUATERN_T;
	...
	ent_optable_lift[INT_T][QUATERN_T] = ent_lift_all_QUATERN_T;
	ent_optable_lift[BIGZ_T][QUATERN_T] = ent_lift_all_QUATERN_T;
#ifdef HAVE_MPQ
	ent_optable_lift[BIGQ_T][QUATERN_T] = ent_lift_all_QUATERN_T;
#endif
#ifdef HAVE_MPF
	ent_optable_lift[BIGF_T][QUATERN_T] = ent_lift_all_QUATERN_T;
#endif
#ifdef HAVE_MPFR
	ent_optable_lift[BIGFR_T][QUATERN_T] = ent_lift_all_QUATERN_T;
#endif
#ifdef HAVE_FPFLOAT
	ent_optable_lift[FLOAT_T][QUATERN_T] = ent_lift_all_QUATERN_T;
#endif
#ifdef HAVE_PSEUG
	ent_optable_lift[BIGG_T][QUATERN_T] = ent_lift_COMPLEX_QUATERN_T;
#endif
#ifdef HAVE_MPC
	ent_optable_lift[BIGC_T][QUATERN_T] = ent_lift_COMPLEX_QUATERN_T;
#endif
}
