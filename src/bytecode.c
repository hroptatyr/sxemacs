...
{									\
	number_type nt1, nt2;						\
									\
	obj1 = ent_normalise_number(obj1);				\
	nt1 = get_number_type(obj1);					\
	obj2 = ent_normalise_number(obj2);				\
	nt2 = get_number_type(obj2);					\
									\
	obj1 = ent_optable_##op[nt1][nt2](obj1, obj2);			\
} while (0)
...
{									\
	...
	nt2 = get_number_type(obj2);					\
									\
	if (NILP(ent_optable_##op1[nt1][nt2](obj1, obj2)))		\
		obj1 = ent_optable_##op2[nt1][nt2](obj1, obj2);		\
	else								\
		obj1 = Qt;						\
} while (0)
...
bytecode_arithop(Lisp_Object obj1, Lisp_Object obj2, Opcode opcode)
{
	...
	switch (opcode) {
	case Bplus:
		result = ent_optable_sum[nt1][nt2](obj1, obj2);
		break;
	case Bdiff:
		result = ent_optable_diff[nt1][nt2](obj1, obj2);
		break;
	case Bmult:
		result = ent_optable_prod[nt1][nt2](obj1, obj2);
		break;
	case Bquo:
		result = ent_optable_div[nt1][nt2](obj1, obj2);
		break;
	case Bmax:
		result = (!NILP(ent_optable_gt[nt1][nt2](obj1, obj2)))
			? obj1 : obj2;
		break;
	case Bmin:
		result = (!NILP(ent_optable_lt[nt1][nt2](obj1, obj2)))
			? obj1 : obj2;
		break;
	default:
		result = Qzero;
