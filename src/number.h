...
#define make_resc_elm(l)	This SXEmacs does not support residue classes
#define make_resc_elm_bz(b)	This SXEmacs does not support residue classes
...
(RATIONALP(x) || REALP(x) || COMPARABLE_INDEF_P(x) || COMPLEXP(x))
