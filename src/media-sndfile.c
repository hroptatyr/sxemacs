...
static uint32_t media_sndfile_sread_audio(media_substream*, void*, uint32_t);
static void media_sndfile_srewind_audio(media_substream*);
...

static uint32_t
media_sndfile_sread_audio(media_substream *mss, void *outbuf, uint32_t length)
{
...
static void
media_sndfile_srewind_audio(media_substream *mss)
{
