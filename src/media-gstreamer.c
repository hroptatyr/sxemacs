...

DECLARE_MEDIA_DRIVER_OPEN_METH(media_gstreamer);
DECLARE_MEDIA_DRIVER_READ_METH(media_gstreamer);
DECLARE_MEDIA_DRIVER_REWIND_METH(media_gstreamer);

DEFINE_MEDIA_DRIVER_CUSTOM(media_gstreamer,
			   media_gstreamer_open, NULL,
			   NULL, NULL,
			   media_gstreamer_read, NULL,
			   media_gstreamer_rewind, NULL);
	      ...
	      GstCaps *caps, gpointer data)
{
	...
	media_stream_set_meths(ms, media_gstreamer);
...
media_gstreamer_open(Lisp_Media_Stream *ms)
{
	/* gstreamer stuff */
	GMainLoop *loop;
...

static size_t
media_gstreamer_read(media_substream *mss, void *outbuf, size_t length)
{
...
static void
media_gstreamer_rewind(media_substream *mss)
{
