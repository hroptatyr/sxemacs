...
INLINE_HEADER int GLYPH_CACHEL_WIDTH(struct window *window, int ind);
INLINE_HEADER int GLYPH_CACHEL_WIDTH(struct window *window, int ind)
{
...
INLINE_HEADER int GLYPH_CACHEL_ASCENT(struct window *window, int ind);
INLINE_HEADER int GLYPH_CACHEL_ASCENT(struct window *window, int ind)
{
...
INLINE_HEADER int GLYPH_CACHEL_DESCENT(struct window *window, int ind);
INLINE_HEADER int GLYPH_CACHEL_DESCENT(struct window *window, int ind)
{
