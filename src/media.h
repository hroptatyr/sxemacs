...
typedef void ms_driver_data;
typedef ms_driver_data*(*ms_open_fun)(Lisp_Media_Stream*);
typedef void(*ms_close_fun)(ms_driver_data*);
typedef void(*ms_print_fun)(Lisp_Object stream, Lisp_Object, int);
typedef Lisp_Object(*ms_mark_fun)(ms_driver_data *driver_data);
...
#define DECLARE_MEDIA_DRIVER_OPEN_METH(_name)				\
	static ms_driver_data *_name##_open(Lisp_Media_Stream*)
#define DECLARE_MEDIA_DRIVER_CLOSE_METH(_name)				\
	static void _name##_close(ms_driver_data*)
...
#define DECLARE_MEDIA_DRIVER_MARK_METH(_name)				\
	static Lisp_Object _name##_mark(ms_driver_data*);
