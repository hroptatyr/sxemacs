...
extern Lisp_Object read_bigz_string(char *cp, int base);
extern inline Lisp_Object ent_mpz_downgrade_maybe(bigz);
...
extern inline Lisp_Object ent_mpq_downgrade_maybe(bigq);
