...
extern inline void sxe_semaphore_init(sxe_semaphore_t);
extern inline void sxe_msemaphore_init(sxe_msemaphore_t);
extern inline void sxe_semaphore_finish(sxe_semaphore_t);
extern inline void sxe_msemaphore_finish(sxe_msemaphore_t);
extern inline void sxe_semaphore_trigger(sxe_semaphore_t);
extern inline void sxe_msemaphore_trigger(sxe_msemaphore_t, int);
extern inline void sxe_semaphore_trigger_all(sxe_semaphore_t);
extern inline void sxe_msemaphore_trigger_all(sxe_msemaphore_t, int);
extern inline void sxe_semaphore_synchronise(sxe_semaphore_t);
extern inline void sxe_msemaphore_synchronise(sxe_msemaphore_t, int);

/* thread-safe refcounter */
extern inline void sxe_refcounter_init(sxe_refcounter_t);
extern inline void sxe_refcounter_finish(sxe_refcounter_t);
extern inline sxe_refcounter_t sxe_refcounter_new(void);
extern inline void sxe_refcounter_free(sxe_refcounter_t);
extern inline int sxe_refcounter_value(sxe_refcounter_t);
extern inline int sxe_refcounter_incref(sxe_refcounter_t);
extern inline int sxe_refcounter_decref(sxe_refcounter_t);
...
extern inline sxe_refcounter_t
