...
extern inline void dllist_pop_and_pro_car(Lisp_Object*, dllist_t);
extern inline void dllist_pop_and_pro_rac(Lisp_Object*, dllist_t);
...
/* inlines */
extern inline void *dllist_car(dllist_t);
extern inline void *dllist_rac(dllist_t);
extern inline size_t dllist_get_size(dllist_t);
extern inline void dllist_prepend_item(dllist_t, dllist_item_t);
extern inline void dllist_append_item(dllist_t, dllist_item_t);
extern inline dllist_item_t dllist_transfer_car(dllist_t);
extern inline dllist_item_t dllist_transfer_rac(dllist_t);
extern inline dllist_item_t dllist_transfer_inner(dllist_t, dllist_item_t);
extern inline void *dllist_pop_inner(dllist_t, dllist_item_t);
