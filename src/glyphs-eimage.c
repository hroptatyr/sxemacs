		 ...
		 int dest_mask, Lisp_Object domain)
{
...

	{
		...
		unwind.eimage =
		    (unsigned char *)xmalloc(cinfo.output_width *
		...
		int dest_mask, Lisp_Object domain)
{
...

	{
		...
		unwind.eimage =
		    xnew_array_and_zero(unsigned char, width * height * 3);
		   ...
		   int dest_mask, Lisp_Object domain)
{
...

	{
		...
		unwind.eimage = (unsigned char *)xmalloc(len);
		ep = unwind.eimage;
