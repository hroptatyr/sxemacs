...
<<<<<<< HEAD
		...
		if test "$with_scrollbars" != "no"; then
			SXE_ADD_SXEUI_OBJS([scrollbar-x.o])
		fi
		if test "$with_dialogs" != "no"; then
			SXE_ADD_SXEUI_OBJS([dialog-x.o])
		fi
		if test "$with_toolbars" != "no"; then
			SXE_ADD_SXEUI_OBJS([toolbar-x.o])
		fi
...
<<<<<<< HEAD
	...
	if test "$with_scrollbars" != "no"; then
		SXE_ADD_SXEUI_OBJS([scrollbar-gtk.o])
	fi
	if test "$with_dialogs" != "no"; then
		SXE_ADD_SXEUI_OBJS([dialog-gtk.o])
	fi
	if test "$with_toolbars" != "no"; then
		SXE_ADD_SXEUI_OBJS([toolbar-gtk.o])
	fi
	if test "$all_widgets" != "no no no no no"; then
