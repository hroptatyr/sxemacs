...
(when (featurep 'resclass)
  (let ((r1 (make-residue-class-ring 23))
    ...
    (Assert (= 2+23Z 25+23Z))
    (Assert (= -2+23Z 21+23Z))
    (Check-Error relation-error (= 2+23Z 2+22Z))
    (Check-Error relation-error (= -2+23Z -2+2Z))
    (Check-Error relation-error (/= 2+23Z 2+22Z))
    (Check-Error relation-error (/= -2+23Z -2+2Z))
...
(Check-Error wrong-type-argument (< 0 not-a-number))
(Check-Error wrong-type-argument (< +infinity not-a-number))
(Check-Error wrong-type-argument (< not-a-number not-a-number))
(Check-Error wrong-type-argument (< complex-infinity not-a-number))
(Check-Error wrong-type-argument (= 0 not-a-number))
(Check-Error wrong-type-argument (= +infinity not-a-number))
(Check-Error wrong-type-argument (= complex-infinity not-a-number))
(Check-Error wrong-type-argument (= not-a-number not-a-number))
...
(Check-Error wrong-type-argument (>= complex-infinity not-a-number))
(Check-Error wrong-type-argument (>= not-a-number not-a-number))
(Check-Error wrong-type-argument (< not-a-number 0))
(Check-Error wrong-type-argument (< not-a-number +infinity))
(Check-Error wrong-type-argument (< not-a-number complex-infinity))
(Check-Error wrong-type-argument (< not-a-number 0 not-a-number))
(Check-Error wrong-type-argument (= not-a-number 0))
(Check-Error wrong-type-argument (= not-a-number +infinity))
(Check-Error wrong-type-argument (= not-a-number complex-infinity))
(Check-Error wrong-type-argument (= not-a-number 0 not-a-number))
