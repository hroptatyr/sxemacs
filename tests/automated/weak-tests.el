...
(let* ((a (cons 23 42))
  ...
  ;; XE 21.5 doesn't have the bug that causes this to fail.  So I have
  ;; disabled this test for 22.1.6--version-0 release, but lets fix it
  ;; in 22.1.7 --SY.
  ;; (if test-harness-test-compiled
