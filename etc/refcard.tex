% Reference Card for SXEmacs on Unix systems
% Time-stamp: <Monday Nov 26, 2007 11:28:48 steve>
%**start of header
...
\title{SXEmacs Reference Card}

\centerline{(for version 21.0+)}

\section{Starting Emacs}

To enter SXEmacs, just type its name: \kbd{sxemacs}
