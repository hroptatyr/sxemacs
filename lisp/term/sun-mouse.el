...
(eval-when-compile
  (globally-declare-boundp
   '(current-global-mousemap current-local-mousemap))
  (globally-declare-fboundp
   '(window-edges sit-for-millisecs sun-menu-internal sun-get-selection sun-set-selection)))
...
(with-boundp 'current-local-mousemap
