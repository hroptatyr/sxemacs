;;; packages.el --- Low level support for SXEmacs packages
...
(defvar packages-special-base-regexp #r"^\(etc\|info\|man\|lisp\|lib-src\|bin\|pkginfo\)$"
