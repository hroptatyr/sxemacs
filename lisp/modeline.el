...
(when (featurep 'tty)
  (set-face-foreground 'modeline-mousable "red" nil '(default color tty)))
...
(when (featurep 'window-system)
  ...
  (set-face-foreground 'modeline-mousable-minor-mode '("green" "green")
...
(when (featurep 'tty)
  (set-face-foreground 'modeline-buffer-id "blue" nil '(default color tty))
