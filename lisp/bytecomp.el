...
;; unused: 184-191
(byte-defop #o0270 0 byte-cl:macro)     ;; think 184 is used now
...
(put 'defregexp 'byte-hunk-handler 'byte-compile-file-form-defvar-or-defconst)
...
(byte-defop-compiler-1 let*)
(byte-defop-compiler-1 cl:do)
(byte-defop-compiler-1 cl:do*)
(byte-defop-compiler-1 cl:dotimes)
(byte-defop-compiler-1 cl:dolist)
(byte-defop-compiler-1 cl:do-symbols)
(byte-defop-compiler-1 cl:do-all-symbols)
(byte-defop-compiler-1 cl:loop)
...
;; generic byte compiler code for emod-cl stuff
(defun byte-compile-cl:macro (form)
  (byte-compile-push-constant form)
  (byte-compile-out 'byte-cl:macro 0))
;; now the macros in detail
(defun byte-compile-cl:do (form)
  (byte-compile-cl:macro form))
(defun byte-compile-cl:do* (form)
  (byte-compile-cl:macro form))
(defun byte-compile-cl:dotimes (form)
  (byte-compile-cl:macro form))
(defun byte-compile-cl:dolist (form)
  (byte-compile-cl:macro form))
(defun byte-compile-cl:do-symbols (form)
  (byte-compile-cl:macro form))
(defun byte-compile-cl:do-all-symbols (form)
  (byte-compile-cl:macro form))
(defun byte-compile-cl:loop (form)
  (byte-compile-cl:macro form))
...
(byte-defop-compiler-1 defregexp byte-compile-defvar-or-defconst)
