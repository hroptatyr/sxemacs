...
;;;***

;;;### (autoloads (about-sxemacs) "about" "lisp/about.el")

(autoload 'about-sxemacs "about" "\
...
;;;***

;;;### (autoloads (curl:download) "ffi-curl" "lisp/ffi-curl.el")

(autoload 'curl:download "ffi-curl" "\
Download URL to and write data to FILE." nil nil)

;;;***

;;;### (autoloads (ffi-load ffi-type-p ffi-define-type ffi-define-type-internal) "ffi" "lisp/ffi.el")

(autoload 'ffi-define-type-internal "ffi" nil nil nil)

(autoload 'ffi-define-type "ffi" "\
...
;;;***

;;;### (autoloads (report-sxemacs-bug) "issue-tracker" "lisp/issue-tracker.el")

(autoload 'report-sxemacs-bug "issue-tracker" nil t nil)
