...
(defun font-lock-force-defaults ()
   ...
   (list
    ...
    (cons
     (concat
      ...
      ;;     "with-string-as-buffer-contents" "with-emacs-type" "do-in-sxemacs"
      ;;     "do-in-xemacs" "do-in-gnu-emacs"
      ...
      #r"ond\(?:ition-case\)?\)\|do\(?:-in-\(?:gnu-emacs\|sxemacs\|"
      #r"xemacs\)\|list\|times\)?\|eval-\(?:a\(?:fter-load\|"
      #r"nd-compile\)\|when-compile\)\|flet\|if\|l\(?:a\(?:bels\|"
      #r"mbda\)\|et\*?\|oop\)\|prog[12nv]?\|return\(?:-from\)?\|"
      #r"save-\(?:current-buffer\|excursion\|match-data\|restriction\|"
      #r"selected-\(?:frame\|window\)\|window-excursion\)\|t\(?:hrow\|"
      #r"rack-mouse\)\|un\(?:less\|wind-protect\)\|w\(?:h\(?:en\|"
      #r"ile\)\|ith-\(?:current-buffer\|emacs-type\|output-to-string\|"
      #r"s\(?:elected-\(?:frame\|window\)\|tring-as-buffer-contents\)\|"
      #r"temp-\(?:buffer\|file\)\)\)"
...
(add-hook 'after-change-major-mode-hook 'font-lock-force-defaults t)
