...
(define-key global-window-system-map '(meta Z) 'zap-up-to-char)
(define-key global-window-system-map "\C-z" 'iconify-frame)
...
(define-key global-window-system-map "\e\e\e" 'keyboard-escape-quit)
